...
public class Information extends Pane{
	...
	public Information(SimpleListProperty<VampireView> vamps,Pistoleros pist,SimpleIntegerProperty timer){
		...
		vamp.setFont(Font.loadFont("file:src/Disko.ttf", 20));
		vamp.setFill(Color.rgb(255,150,50));
		vampSuite.setFont(Font.loadFont("file:src/Disko.ttf", 20));
		...
		Text timeS = new Text();
		timeT.setFont(Font.loadFont("file:src/Disko.ttf", 20));
		timeT.setFill(Color.rgb(255,150,50));
		timeS.setFont(Font.loadFont("file:src/Disko.ttf", 20));
		...
		pistScore.setFont(Font.loadFont("file:src/Disko.ttf", 20));
		pistScore.setFill(Color.rgb(255,150,50));
		Text score = new Text();
		score.setFont(Font.loadFont("file:src/Disko.ttf", 20));
		...
		pistText.setFont(Font.loadFont("file:src/Disko.ttf", 20));
		pistText.setFill(Color.rgb(255,150,50));
		Text pistSuite = new Text();
		pistSuite.setFont(Font.loadFont("file:src/Disko.ttf", 20));
		...
		pistLife.setFont(Font.loadFont("file:src/Disko.ttf", 20));
